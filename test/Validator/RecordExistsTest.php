...
use LaminasFriends\Mvc\User\Validator\RecordExists as Validator;
...
class RecordExistsTest extends TestCase
{
    ...
    public function testIsInvalid()
    {
        ...
        static::assertEquals($options['messageTemplates'][AbstractRecord::ERROR_NO_RECORD_FOUND], $options['messages'][AbstractRecord::ERROR_NO_RECORD_FOUND]);
    }
}
